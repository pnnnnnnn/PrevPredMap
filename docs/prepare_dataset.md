...
```
python tools/ppmap/custom_nusc_map_converter.py --root-path ./data/nuscenes --out-dir ./data/nuscenes --extra-tag nuscenes --version v1.0 --canbus ./data
```
...
*We genetate custom annotation files which are different from mmdet3d's*
```
python tools/ppmap/custom_av2_map_converter.py --data-root ./data/argoverse2/sensor/
```
